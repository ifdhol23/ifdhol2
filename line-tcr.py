...
import IFDHOL
from IFDHOL.lib.curve.ttypes import *
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
                ...
                if msg.toType == 2:
                    ...
                    ki.updateGroup(X)
                    if wait["lang"] == "JP":
                        ki.sendText(msg.to,"Done ifdhol")
                    else:
                ...
                if msg.toType == 2:
                    ...
                    kk.updateGroup(X)
                    if wait["lang"] == "JP":
                        kk.sendText(msg.to,"Done ifdhol")
                    else:
                ...
                if msg.toType == 2:
                    ...
                    kc.updateGroup(X)
                    if wait["lang"] == "JP":
                        kc.sendText(msg.to,"Done ifdhol")
                    else:
...
#-----------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    ki.sendText(msg.to,"Mampus lu njing")
                    kk.sendText(msg.to,"Group Lu gw ratain TOT")
...
#-----------------------------------------------
                ...
                ki.sendText(msg.to,"Selamat datang di ifdhol Family Room")
...
#-----------------------------------------------
                ...
                ki.sendText(msg.to,"Apaan Tot")
                kk.sendText(msg.to,"Gak usah panggil gue")
                kc.sendText(msg.to,"Dasar kalian Kids Jaman Now")
#-----------------------------------------------
            ...
            for zx in range(0,20):
                ...
                if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
                    try:    
                        ...
                        cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by line://ti/p/~ifdhol19")
                        kk.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
                        kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like By line://ti/p/~ifdhol19")
                        print "Like"
                    except:
                            pass
                else:
